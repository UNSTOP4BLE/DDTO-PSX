...
//freak1 functions
void week1_freak1_SetFrame(void *user, u8 frame)
{
...
void week1_freak1_Draw(Back_week1 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
//freak0 functions
void week1_freak0_SetFrame(void *user, u8 frame)
{
	Back_week1 *this = (Back_week1*)user;
...
void week1_freak0_Draw(Back_week1 *this, fixed_t x, fixed_t y)
{
	//Draw character
...
void Back_week1_DrawBG(StageBack *back)
{
	...
	Animatable_Animate(&this->freak0_animatable, (void*)this, week1_freak0_SetFrame);
	Animatable_Animate(&this->freak1_animatable, (void*)this, week1_freak1_SetFrame);
	
	if (stage.stage_id == StageId_1_2) {
		week1_freak0_Draw(this, FIXED_DEC(-120,1) - fx, FIXED_DEC(40,1) - fy);
		week1_freak0_Draw(this, FIXED_DEC(50,1) - fx, FIXED_DEC(40,1) - fy);
		week1_freak0_Draw(this, FIXED_DEC(-40,1) - fx, FIXED_DEC(40,1) - fy);
		week1_freak1_Draw(this, FIXED_DEC(90,1) - fx, FIXED_DEC(40,1) - fy);
		week1_freak1_Draw(this, FIXED_DEC(0,1) - fx, FIXED_DEC(40,1) - fy);
		week1_freak1_Draw(this, FIXED_DEC(-80,1) - fx, FIXED_DEC(40,1) - fy);
	}
	...
	static const struct Back_week1_FGTree
	{
		RECT src;
		fixed_t x, y;
		fixed_t off[4];
	...
	const struct Back_week1_FGTree *fg_tree_p = fg_tree;
...
StageBack *Back_week1_New(void)
{
	...
	this->arc_freak0 = IO_Read("\\WEEK1\\BACK.ARC;1");
	this->arc_freak0_ptr[0] = Archive_Find(this->arc_freak0, "back2.tim");
	
	this->arc_freak1 = IO_Read("\\WEEK1\\BACK.ARC;1");
